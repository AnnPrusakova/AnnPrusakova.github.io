<?php
if(isset($_POST['contactFrmSubmit']) && !empty($_POST['name']) !empty($_POST['secondname']) && !empty($_POST['email']) && (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) === false) && !empty($_POST['phone'])   && !empty($_POST['message'])){
